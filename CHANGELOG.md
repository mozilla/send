...
- [#469](https://github.com/mozilla/send/pull/469) Increase minimum node version to 8.2.0 (@ehuggett)
...
- [#185](https://github.com/mozilla/send/pull/185) added loading, hashing, and encrypting events for uploader; decrypting (@abhinadduri)
...
- [#111](https://github.com/mozilla/send/pull/111) added in anonymized ip google analytics (@abhinadduri)
...
- [#42](https://github.com/mozilla/send/pull/42) changed to handle 404 during download, also removing progress listener (@abhinadduri)
